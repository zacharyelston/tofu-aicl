...
3.  **Authorize Resources**: The pipeline will pause and ask for permission to use the `ancera-service-connection`. An administrator must approve this. This is a one-time action.
